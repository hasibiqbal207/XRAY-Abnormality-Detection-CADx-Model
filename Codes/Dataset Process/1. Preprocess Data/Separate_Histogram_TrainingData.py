...
for directory in file_readable:  
    for filename in os.listdir(directory[0]):
        ...
        if ( "XR_ELBOW" in directory[0] ):
            if directory[1] == '0':
                dir_his = "Dataset_Histogram/XR_ELBOW/Train/Abnormal"
                ...
                dir_his = "Dataset_Histogram/XR_ELBOW/Train/Normal"
                if not os.path.exists(dir_his):
                    os.makedirs(dir_his)                    
            ...
            if directory[1] == '0':
                dir_his = "Dataset_Histogram/XR_FINGER/Train/Abnormal"
                if not os.path.exists(dir_his):
                    os.makedirs(dir_his)
                ...
                dir_his = "Dataset_Histogram/XR_FINGER/Train/Normal"
                if not os.path.exists(dir_his):
                    os.makedirs(dir_his)
            ...
            if directory[1] == '0':
                dir_his = "Dataset_Histogram/XR_FOREARM/Train/Abnormal"
                if not os.path.exists(dir_his):
                    os.makedirs(dir_his)                    
                ...
                dir_his = "Dataset_Histogram/XR_FOREARM/Train/Normal"
                if not os.path.exists(dir_his):
                    os.makedirs(dir_his)               
            ...
            if directory[1] == '0':
                dir_his = "Dataset_Histogram/XR_HAND/Train/Abnormal"
                if not os.path.exists(dir_his):
                    os.makedirs(dir_his)                   
                ...
                dir_his = "Dataset_Histogram/XR_HAND/Train/Normal"
                if not os.path.exists(dir_his):
                    os.makedirs(dir_his)                  
            ...
            if directory[1] == '0':
                dir_his = "Dataset_Histogram/XR_HUMERUS/Train/Abnormal"
                if not os.path.exists(dir_his):
                    os.makedirs(dir_his)                   
                ...
                dir_his = "Dataset_Histogram/XR_HUMERUS/Train/Normal"
                if not os.path.exists(dir_his):
                    os.makedirs(dir_his)                    
            ...
            if directory[1] == '0':
                dir_his = "Dataset_Histogram/XR_SHOULDER/Train/Abnormal"
                if not os.path.exists(dir_his):
                    os.makedirs(dir_his)                    
                ...
                dir_his = "Dataset_Histogram/XR_SHOULDER/Train/Normal"
                if not os.path.exists(dir_his):
                    os.makedirs(dir_his)                   
            ...
            if directory[1] == '0':
                dir_his = "Dataset_Histogram/XR_WRIST/Train/Abnormal"
                if not os.path.exists(dir_his):
                    os.makedirs(dir_his)                    
                ...
                dir_his = "Dataset_Histogram/XR_WRIST/Train/Normal"
                if not os.path.exists(dir_his):
                    os.makedirs(dir_his)                   
