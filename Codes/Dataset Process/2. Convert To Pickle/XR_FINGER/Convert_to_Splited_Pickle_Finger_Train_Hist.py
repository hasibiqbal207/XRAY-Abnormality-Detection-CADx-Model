...
# directory
img_dir = "Splited_XR_FINGER_HIST/Train"
...
import pickle
pickle_out=open("Splited_X_Train_FINGER_HIST_420.pickle","wb")
pickle.dump(xs,pickle_out)
pickle_out.close()

pickle_out=open("Splited_Y_Train_FINGER_HIST_420.pickle","wb")
