...
# directory
img_dir = "Uniform_XR_FINGER_HIST"
...
if img_size == 256:
    ...
    import pickle
    pickle_out=open("Uniform_X_FINGER_HIST_256.pickle","wb")
    pickle.dump(xs,pickle_out)
    pickle_out.close()
    
    pickle_out=open("Uniform_Y_FINGER_HIST_256.pickle","wb")
    ...
    import pickle
    pickle_out=open("Uniform_X_FINGER_HIST_420.pickle","wb")
    pickle.dump(xs,pickle_out)
    pickle_out.close()
    
    pickle_out=open("Uniform_Y_FINGER_HIST_420.pickle","wb")
    pickle.dump(ys,pickle_out)
    pickle_out.close()
