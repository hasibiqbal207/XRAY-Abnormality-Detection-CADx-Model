...
# directory
img_dir = "Splited_XR_ELBOW_HIST/Validation"
...
import pickle
pickle_out=open("Splited_X_Test_ELBOW_HIST_256.pickle","wb")
pickle.dump(xs,pickle_out)
pickle_out.close()

pickle_out=open("Splited_Y_Test_ELBOW_HIST_256.pickle","wb")
