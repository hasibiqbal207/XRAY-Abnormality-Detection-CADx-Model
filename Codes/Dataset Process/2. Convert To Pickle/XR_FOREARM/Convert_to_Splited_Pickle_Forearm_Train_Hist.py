...
# directory
img_dir = "Splited_XR_FOREARM_HIST/Train"
...
import pickle
pickle_out=open("Splited_X_Train_Forearm_HIST_256.pickle","wb")
pickle.dump(xs,pickle_out)
pickle_out.close()

pickle_out=open("Splited_Y_Train_Forearm_HIST_256.pickle","wb")
