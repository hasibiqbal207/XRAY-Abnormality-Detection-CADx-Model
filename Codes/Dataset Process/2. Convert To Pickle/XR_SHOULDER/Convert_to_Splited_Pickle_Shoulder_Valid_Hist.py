# -*- coding: utf-8 -*-
"""
Created on Sat Dec  8 15:31:53 2018
...
# directory
img_dir = "Splited_XR_SHOULDER_HIST/Validation"
...
import pickle
pickle_out=open("Splited_X_Test_Shoulder_HIST_420.pickle","wb")
pickle.dump(xs,pickle_out)
pickle_out.close()

pickle_out=open("Splited_Y_Test_Shoulder_HIST_420.pickle","wb")
