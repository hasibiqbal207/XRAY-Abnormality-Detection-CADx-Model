...
t1=time.time()
x_train = pickle.load(open("Splited_X_Train_FINGER_HIST_256.pickle","rb"))
y_train = pickle.load(open("Splited_Y_Train_FINGER_HIST_256.pickle","rb"))
y_train = to_categorical(y_train,2)
t2=time.time()
print("time to load :",(t2-t1))

t1=time.time()
x_test = pickle.load(open("Splited_X_Test_FINGER_HIST_256.pickle","rb"))
y_test = pickle.load(open("Splited_Y_Test_FINGER_HIST_256.pickle","rb"))
y_test_ROC = y_test
...
model_checkpoint = ModelCheckpoint('Finger_ResNET_Model_by_Machine.h5', verbose=1, save_best_only=True)
...
def fit_and_evaluate(X_Train, X_Test, Y_Train, Y_Test, y_test_ROC):
    ...
    model.save('Finger_ResNET50_Model.h5')
