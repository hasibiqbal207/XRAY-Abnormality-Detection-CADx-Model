...
for i in range(lenth):
    img = np.reshape(X_Test[5],[1,256,256,3])
...
#import cv2
#img_sin = cv2.imread('abnormal_XR_ELBOW_hist_161.png')
#img_sin = np.reshape(img_sin,[1,256,256,3])